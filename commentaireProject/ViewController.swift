...
//  commentaireProject
//
//  Created by eleves on 2017-10-05.
...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //---
        stylizeSlotImageViews(radius: 10, borderWidth: 0.5, borderColor: UIColor.red.cgColor, bgColor: UIColor.yellow.cgColor)
        //----
        stylizeBackgroundViews(radius: 10, borderWidth: nil, borderColor: UIColor.black.cgColor, bgColor: nil)
        //---
        createDeckOfCards()
        //---
    }
    ...
    //------------------------------------------
    func stylizeBackgroundViews( radius r: CGFloat, borderWidth w: CGFloat?, borderColor c: CGColor, bgColor g: CGColor?){
        for bgViews in arrOfBackgrounds {
            bgViews.clipsToBounds = true
            bgViews.layer.cornerRadius = r
            bgViews.layer.borderWidth = w ?? 0
            bgViews.layer.borderColor = c
            bgViews.layer.backgroundColor = g
        }
    }
    //------------------------------------------
    func fillUpArrays() {
        arrOfCardImages = [card_blur_1, card_blur_2, card_blur_3, card_blur_4, card_blur_5] // array of card blur
    ...
    func createCardObjectsFromImages() {
        card_blur_1 = UIImage(named: "card_blur_1.png")
        card_blur_2 = UIImage(named: "card_blur_2.png")
        card_blur_3 = UIImage(named: "card_blur_3.png")
        card_blur_4 = UIImage(named: "card_blur_4.png")
        card_blur_5 = UIImage(named: "card_blur_5.png")
    ...
    @IBAction func play(_ sender: UIButton) {
        ...
        //---
        Timer.scheduledTimer(timeInterval: 2.55, target: self, selector: #selector(displayRandomCards), userInfo: nil, repeats: false)
    }
    //------------------------------------------
    ...
    func displayCards (arrOfCards: [String]) {
        ...
        if chances == 0 {
            ...
            allIn.alpha = 1
            if credits == 0 {
                again.alpha = 1 // MONTRE LE BUTTON AGAIN !!!!
                bet100.alpha = 0.5
                allIn.alpha = 0.5
                dealButton.alpha = 0.5
            }
    ...
    @IBAction func cardsToHold(_ sender: UIButton) {
        ...
        if arrOfBackgrounds[sender.tag].layer.borderWidth == 0.5 {
            ...
            arrOfBackgrounds[sender.tag].layer.backgroundColor = UIColor(colorLiteralRed: 0.0, green: 0.0, blue: 1.0, alpha: 0.5).cgColor
